...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!--xsl:attribute-set name="topic.title" use-attribute-sets="common.title common.border__bottom"> by JP-->
    <xsl:attribute-set name="topic.title" use-attribute-sets="common.title common.border__top common.border__bottom common.border__right common.border__left">
    <xsl:attribute name="border-after-width">3pt</xsl:attribute>
    <xsl:attribute name="border-after-width">50pt</xsl:attribute> <!-- by JP 定義 border 後的列距，需與 common.border__bottom 的線粗配合-->
        <xsl:attribute name="space-before">0pt</xsl:attribute> <!-- 後面的定義會覆蓋前面的定義-->
        <xsl:attribute name="space-before">500pt</xsl:attribute> <!-- 定義border line前的間距，但目前修改無效果-->
        <xsl:attribute name="space-after">16.8pt</xsl:attribute> 
        <xsl:attribute name="space-after">50pt</xsl:attribute> <!-- 定義border line後的間距-->
        <xsl:attribute name="font-size">18pt</xsl:attribute>
        <xsl:attribute name="font-weight">bold</xsl:attribute>
        <xsl:attribute name="padding-top">160.8pt</xsl:attribute> <!-- 定義標題字前與border line的間距-->
        <xsl:attribute name="padding-bottom">16.8pt</xsl:attribute> <!-- add by JP 定義標題字後與border line的間距-->
