...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:attribute-set name="common.border__top">
	...
	<xsl:attribute name="border-before-width">100pt</xsl:attribute> <!-- 後面的定義可以覆蓋前面的定義 -->
    <xsl:attribute name="border-before-color">green</xsl:attribute> <!-- 後面的定義可以覆蓋前面的定義 -->
  ...
  <xsl:attribute-set name="common.border__bottom">
	...
	<xsl:attribute name="border-after-width">100pt</xsl:attribute>
  ...
  <xsl:attribute-set name="common.title">
    <!--<xsl:attribute name="font-family">sans-serif</xsl:attribute> by JP -->
  ...
  <xsl:attribute-set name="common.link">
    ...
    <xsl:attribute-set name="__fo__root" use-attribute-sets="base-font">
        <xsl:attribute name="font-family">serif</xsl:attribute> <!-- by JP -->
